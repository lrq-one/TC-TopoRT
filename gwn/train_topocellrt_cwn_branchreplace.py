...
from net.topocellrt_cwn_branchreplace import TopoCellRTCWNBranchReplace
...
class Config:
    ...
    RESULT_DIR = os.getenv('RESULT_DIR', 'results_TopoCellRT_CWNReplace') 
...
def main():
    ...
    # --- 下方的模型初始化与训练循环保持原样不变 ---
    model = TopoCellRTCWNBranchReplace(
        emb_dim=256,
