...
RUNS = {
    ...
    "seed5_soup": "results_OOF_DualView_Stack_seed5_soup",
}

# Added for seed5 fold-weight soup transfer.
# Copy all metadata fields from seed5 and only replace checkpoint directory.
if "seed5_soup" not in RUNS or isinstance(RUNS["seed5_soup"], str):
    RUNS["seed5_soup"] = dict(RUNS["seed5"])
    RUNS["seed5_soup"]["dir"] = "results_OOF_DualView_Stack_seed5_soup"
