...
def main():
    ...
    in_dir = Path("experiments_candidate_filtering/metabobase_calibration_prediction_inputs")
    origin_csv = in_dir / "metabobase_calibration_true_origin.csv"
    taut_csv = in_dir / "metabobase_calibration_true_taut_strict.csv"
    unique_csv = in_dir / "metabobase_calibration_true_unique_smiles.csv"
    row_map_csv = in_dir / "metabobase_calibration_true_row_map.csv"

    out_dir = Path("experiments_candidate_filtering/metabobase_calibration_predictions")
    pred_cache = out_dir / "fold_pred_cache"
    out_dir.mkdir(parents=True, exist_ok=True)
    pred_cache.mkdir(parents=True, exist_ok=True)

    root_origin = Path("experiments_candidate_filtering/metabobase_calibration_datasets/origin")
    root_taut = Path("experiments_candidate_filtering/metabobase_calibration_datasets/taut")
    ...
    by_seed.to_csv(out_dir / "metabobase_calibration_true_predictions_by_seed.csv", index=False)
    ...
    unique_pred.to_csv(out_dir / "metabobase_calibration_true_unique_predictions.csv", index=False)
    ...
    row_pred.to_csv(out_dir / "metabobase_calibration_true_predictions_final.csv", index=False)

    print("[saved]", out_dir / "metabobase_calibration_true_predictions_by_seed.csv", by_seed.shape)
    print("[saved]", out_dir / "metabobase_calibration_true_unique_predictions.csv", unique_pred.shape)
    print("[saved]", out_dir / "metabobase_calibration_true_predictions_final.csv", row_pred.shape)
