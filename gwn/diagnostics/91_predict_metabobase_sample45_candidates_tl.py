...
SPLIT_DIR = Path("experiments_candidate_filtering/metabobase_tl_sample45/seed42")
TRAIN_DIR = Path("experiments_candidate_filtering/metabobase_tl_sample45_training/seed42")
OUT_DIR = Path("experiments_candidate_filtering/metabobase_sample45_predictions_tl_seed42")
...
def main():
    ...
    meta = pd.read_csv(SPLIT_DIR / "metabobase_test45_sample45_metadata.csv")
    ...
    origin_csv = OUT_DIR / "sample45_unique_candidate_origin_for_prediction.csv"
    taut_csv = OUT_DIR / "sample45_unique_candidate_taut_for_prediction.csv"
    unique_csv = OUT_DIR / "sample45_unique_candidate_smiles.csv"
    row_map_csv = OUT_DIR / "sample45_candidate_row_map.csv"
    ...
    print("sample45 queries:", len(meta))
    ...
    unique_out.to_csv(OUT_DIR / "sample45_unique_candidate_predictions_tl_seed42.csv", index=False)
    final.to_csv(OUT_DIR / "sample45_candidate_predictions_tl_seed42.csv", index=False)
    ...
    qstat.to_csv(OUT_DIR / "sample45_query_candidate_stats.csv", index=False)

    print("=" * 100)
    print("[saved]")
    print(OUT_DIR / "sample45_candidate_predictions_tl_seed42.csv")
    print(OUT_DIR / "sample45_unique_candidate_predictions_tl_seed42.csv")
    print(OUT_DIR / "sample45_query_candidate_stats.csv")
    print("=" * 100)
