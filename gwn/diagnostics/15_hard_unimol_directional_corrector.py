...
def main():
        ...
        for alpha in np.linspace(0.0, 0.8, 81):
            for tau in [0.50, 0.55, 0.60, 0.65, 0.70, 0.75]:
                for min_mag in [0, 20, 40, 60]:
                    ...
                    penalty_medae = max(0.0, m["MedAE"] - base_val_m["MedAE"])
    ...
    scan = pd.DataFrame(
        ...
        columns=[
            "alpha", "cap", "tau", "min_mag", "score",
            "val_MAE", "val_MedAE", "val_P95", "val_P99",
            "val_80", "val_100", "val_200", "val_used"
        ]
    )
