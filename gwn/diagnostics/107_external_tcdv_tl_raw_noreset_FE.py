...
def run_one_view_cv(
    ...
    for cv_fold, (tr_local, te_local) in enumerate(split_iter):
        ...
        scheduler = CosineAnnealingWarmRestarts(optimizer, T_0=150)
...
def main():
    ...
    print("=== Stage 4AN raw no-reset FE-style external transfer learning ===")
