...
IN_DIR = Path("experiments_candidate_filtering/metabobase_tl_sample45/seed42")
OUT_DIR = Path("experiments_candidate_filtering/metabobase_tl_sample45_training")
...
def prepare_view_csvs():
    train_origin_src = IN_DIR / "metabobase_train181_sample45_for_model.csv"
    test_origin_src = IN_DIR / "metabobase_test45_sample45_for_model.csv"

    train_origin = IN_DIR / "metabobase_train181_sample45_origin_shift300_for_model.csv"
    test_origin = IN_DIR / "metabobase_test45_sample45_origin_shift300_for_model.csv"
    train_taut = IN_DIR / "metabobase_train181_sample45_taut_shift300_for_model.csv"
    test_taut = IN_DIR / "metabobase_test45_sample45_taut_shift300_for_model.csv"
