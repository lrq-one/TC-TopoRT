...
IN_DIR = Path("experiments_candidate_filtering/riken_tl_exact85")
OUT_DIR = Path("experiments_candidate_filtering/riken_tl_exact85_training")
...
def prepare_view_csvs():
    train_origin_src = IN_DIR / "riken_train341_exactS11_for_model.csv"
    test_origin_src = IN_DIR / "riken_test85_exactS11_for_model.csv"

    train_origin = IN_DIR / "riken_train341_exactS11_origin_shift300_for_model.csv"
    test_origin = IN_DIR / "riken_test85_exactS11_origin_shift300_for_model.csv"
    train_taut = IN_DIR / "riken_train341_exactS11_taut_shift300_for_model.csv"
    test_taut = IN_DIR / "riken_test85_exactS11_taut_shift300_for_model.csv"
