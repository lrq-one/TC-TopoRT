...
OUT = ROOT / "artifacts/results/candidate_filtering/sensitivity"
OUT.mkdir(parents=True, exist_ok=True)

DATASETS = {
    "MetaboBase_evaluable45": {
        "summary": BASE / 'data/candidate_filtering/metabobase_rank_guard_soft_grid.csv',
    ...
    "RIKEN_exact85": {
        "summary": BASE / 'data/candidate_filtering/riken_rank_guard_soft_grid.csv',
