...
def build_bank(df: pd.DataFrame, source_folds):
    ...
    # Use one fixed candidate set rather than dataset-specific manual selection.
    ...
    # View disagreement is retained for diagnostics, not used as a learned feature here.
