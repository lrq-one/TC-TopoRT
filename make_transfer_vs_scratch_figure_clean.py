...
INPUT_CANDIDATES = [
    ...
    ROOT / "paper_results_TCDV_TopoRT/tl_vs_scratch/tl_vs_scratch_summary.csv",
]
...
OUT_DIR_JCIM = ROOT / "manuscript_figures_jcim"
OUT_DIR_JCIM.mkdir(parents=True, exist_ok=True)

OUT_PNG_JCIM = OUT_DIR_JCIM / "fig_tl_vs_scratch_improvement.png"
OUT_PDF_JCIM = OUT_DIR_JCIM / "fig_tl_vs_scratch_improvement.pdf"
...
def main():
    ...
    fig.savefig(OUT_PDF_JCIM, bbox_inches="tight", pad_inches=0.03)
    fig.savefig(OUT_PNG_JCIM, dpi=600, bbox_inches="tight", pad_inches=0.03)

    print("[INPUT]", in_path.relative_to(ROOT))
    print("[SAVE]", OUT_PDF.relative_to(ROOT))
    print("[SAVE]", OUT_PNG.relative_to(ROOT))
    print("[SAVE]", OUT_PDF_JCIM.relative_to(ROOT))
    print("[SAVE]", OUT_PNG_JCIM.relative_to(ROOT))
    print()
